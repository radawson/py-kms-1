...
class KmsGui(tk.Tk):
        ...
        def gui_clt(self):
                ...
                # Office Installation ID (OID)
                cltoidlbl = tk.Label(self.pagewidgets["Clt"]["PageWin"]["PageStart"], text = "OID: ", font = self.customfonts['opt'])
                self.cltoid = tk.Entry(self.pagewidgets["Clt"]["PageWin"]["PageStart"], width = 10, font = self.customfonts['opt'], name = "oid")
                self.cltoid.insert('end', str(clt_options['oid']['def']))
                ToolTip(self.cltoid, text = "Office Installation ID (Informational)", wraplength = self.wraplength)
                # Logfile.
                ...
                cltoidlbl.grid(row = 6, column = 0, padx = 5, pady = 5, sticky = 'e')
                self.cltoid.grid(row = 6, column = 1, padx = 5, pady = 5, sticky = 'ew')
                cltfilelbl.grid(row = 7, column = 0, padx = 5, pady = 5, sticky = 'e')
                self.cltfile.grid(row = 7, column = 1, padx = 5, pady = 5, sticky = 'ew')
                cltfilebtnwin.grid(row = 7, column = 2, padx = 5, pady = 5, sticky = 'ew')
                self.chkcltfile.grid(row = 8, column = 1, padx = 5, pady = 5, sticky = 'ew')
                cltlevellbl.grid(row = 9, column = 0, padx = 5, pady = 5, sticky = 'e')
                self.cltlevel.grid(row = 9, column = 1, padx = 5, pady = 5, sticky = 'ew')
                cltsizelbl.grid(row = 10, column = 0, padx = 5, pady = 5, sticky = 'e')
                self.cltsize.grid(row = 10, column = 1, padx = 5, pady = 5, sticky = 'ew')
